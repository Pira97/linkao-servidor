...
/// La amistad es por CUENTA: la clave (target) es la CUENTA destinataria y el valor es
/// "cuentaSolicitante|nombrePersonajeSolicitante" (el nombre es solo para mostrar en el panel).
/// Un único solicitante pendiente por cuenta destinataria (igual que QuienAmigo en memoria).
/// Archivo "amigo_requests.dat" en Charfile: una línea por solicitud "CUENTA_DESTINO=CUENTA_SOLICITANTE|NOMBRE".
/// </summary>
