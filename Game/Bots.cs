...
public static class Bots
{
    ...
    public static NpcManager.NpcInstance Spawn(int map, byte x, byte y, byte clase, byte raza = 0, int owner = 0, byte faccion = 0, byte heading = 0, byte genero = 1, byte nivel = 50, bool leveling = false, bool smart = false, string nick = null, int copiarNpc = 0, int estado = -1)
    {
        EnsureLoaded();
