...
///   &lt;seg&gt; aparece  &lt;id&gt; &lt;clase&gt; &lt;x&gt; &lt;y&gt; &lt;rumbo&gt; [npc=N] [bando=S] [barca] Nombre visible
    ...
    private static void Ejecutar(Orden o)
    {
        ...
        switch (o.Verbo)
        {
            ...
            case "aparece":
            {
                ...
                Quitar(id);
                var bot = Bots.Spawn(_map, x, y, clase, heading: rumbo, nick: nombre, copiarNpc: copiar, estado: estado);
