...
public enum ServerPacketID : short
{
    ...
    // --- Vida de un NPC (NUEVO, no VB6), SOLO al jugador que le acaba de pegar: el cliente
    //     dibuja una barra debajo del NPC por unos segundos. Requiere ClientCaps bit7
    //     (Connection.SoportaVidaNpc). Ver Combat.NotificarVidaNpc. ---
    NpcHp = 221, // Integer charIndex, Long minHP, Long maxHP
}
